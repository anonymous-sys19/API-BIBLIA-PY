...
def admin_routes(app: FastAPI):
    ...
    async def admin_home(request: Request):
        return render_template("admin/base.html", {"active": "home"}, request)
    ...
    async def admin_streams(request: Request):
        ...
        return render_template("admin/streams.html", {"active": "streams", "streams": streams_dict}, request)
    ...
    async def create_stream(
        ...
        return {"status": "success", "message": "Radio creada"}
    ...
    async def admin_videos(request: Request):
        ...
        return render_template("admin/videos.html", {"active": "videos", "videos": videos_dict}, request)
    ...
    async def create_video(
        ...
        if not miniatura_url and video_id:
            miniatura_url = f"https://i.ytimg.com/vi/{video_id}/hqdefault.jpg"
        video = Video(id=None, video_id=video_id, titulo=titulo, canal_autor=canal_autor or None, tipo=tipo, miniatura_url=miniatura_url or None)
        video_manager.agregar_video(video)
